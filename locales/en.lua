Locales['en'] = {
  ...
  ['jobs_item'] = '$%s',
  ['not_work_hour']             = '~y~This is not right time to work. Take a rest and come back an working hours~y~',
  -- license
  ['license_title'] = 'You are required to own a license to process this job ',
  ['license_no'] = 'no',
  ['license_bought'] = 'you bought the ~b~%s~s~ for ~r~$%s~s~',
  ['license_bought_fail'] = 'you cannot afford an ~b~%s~s~!',
  ['license_not_allowed']       = '~r~You dont have license to do the job~r~',
  -- Lumber Jack job
  ...
  ['lj_pickupprompt']            = 'press ~INPUT_CONTEXT~ to harvest the ~g~Wood~s~.',
  ...
  ['f_license']                 = 'Fueler Job License',
  ['f_pickupprompt']            = 'press ~INPUT_CONTEXT~ to harvest the ~g~Oil~s~.',
  ...
  ['s_pickupprompt']            = 'press ~INPUT_CONTEXT~ to catch the ~g~Alive Chicken~s~.',
  -- Dress Designer
  ...
  ['dd_pickupprompt']            = 'press ~INPUT_CONTEXT~ to catch the ~g~Deer~s~.',
  }
